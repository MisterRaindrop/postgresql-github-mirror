 ...
 * found, false otherwise.  This is per the table_index_scan_begin interface.
 *
							...
							BlockNumber heapblkno)
{
	 ...
	 * result could be slightly stale.  See the "Memory ordering effects"
	 * discussion above visibilitymap_get_status for an explanation of why
	 * this is okay.
	 */
